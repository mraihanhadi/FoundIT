...
<nav class="drawer" id="drawer">
  <div class="drawer-header">
    <img src="{{ asset('gambar/admin.jpg') }}" alt="Admin" class="drawer-avatar"
      onerror="this.src='https://ui-avatars.com/api/?name=Admin&background=7B9EFF&color=fff'">
    <div>
      <div class="drawer-user-name">Admin</div>
      <div class="drawer-user-email">admin@foundit.ac.id</div>
    </div>
  </div>
...
<header class="app-header">
  ...
  <div class="header-profile">
    <button class="profile-btn" onclick="toggleProfileDropdown()">
      <img src="{{ asset('gambar/admin.jpg') }}" alt="Admin" class="profile-avatar"
        onerror="this.src='https://ui-avatars.com/api/?name=Admin&background=7B9EFF&color=fff'">
    </button>
    <div class="profile-dropdown" id="profileDropdown">
      <div class="dropdown-info">
        <div class="d-name">Admin</div>
        <div class="d-email">admin@foundit.ac.id</div>
      </div>
